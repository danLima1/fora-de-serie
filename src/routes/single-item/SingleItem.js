...
const SingleItem = ({ handleAddProduct, handleRemoveProduct }) => {
  ...
  useEffect(() => {
    document.title = `${singleProduct.ItemName}|  fora de Série`;
          ...
          <section className="price">
            {singleProduct.sale === true ?
              <section className="sale-pricing">
                <p className="price-num-before"><span>R$</span>{singleProduct.ItemPriceBefore}</p>
                <p className="price-num"><span>R$</span>{singleProduct.ItemPrice}</p>
              </section>
              :
              <p className="price-num"><span>R$</span>{singleProduct.ItemPrice}</p>
            }
